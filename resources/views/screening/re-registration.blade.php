    ...
    <section class="personal-data py-5" id="personal-data">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <form action="{{ route('respondent.saveReRegistration', auth()->user()->id) }}" method="post"
                                ...
                                <div class="current-address">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror"
                                            name="address" id="addressTextArea" rows="3"></textarea>
                                        @error('address')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <p class="text-muted fs-14px">* Jika alamat saat ini tidak diisi maka akan disesuaikan
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    <a class="btn btn-outline-default w-100" href="{{ URL::previous() }}"
                                        role="button">Kembali</a>
                                </div>
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-default text-white w-100"
