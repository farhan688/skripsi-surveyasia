                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        @elseif (Auth::user()->provider_name != null)
                            <img src="{{ Auth::user()->avatar }}" alt="{{ Auth::user()->nama_lengkap }}" width="110"
                                class="img-fluid d-block mb-2 ms-3 rounded-pill object-fit-cover">
                        @else
                            <img src="{{ Storage::url(\Auth::user()->avatar) }}" width="110" height="110"
                    ...
                    <div class="col">
                        <div class="d-flex align-items-center">
                            ...
                            @if (Auth::user()->role_id == 3)
                                <img src="{{ Storage::url(Auth::user()->badge->image_path) }}" alt="badge" class="ms-2" style="width: 50px !important; height: 50px !important;">
                            @endif
                        </div>
                        ...
                        @elseif(Auth::user()->subscription_id == 1)
                            ...
                            <a href="{{ route('researcher.pricings.index') }}" class="btn btn-orange btn-sm"
                                role="button">Upgrade
                            </a>
                        @else
                            <p>hai</p>
