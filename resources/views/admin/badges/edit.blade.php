                ...
                <div class="container mt-4">
                    ...
                    <form action="{{ route('admin.badges.update', $badge->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="max_threshold_points" name="max_threshold_points" value="{{ $badge->max_threshold_points }}" placeholder="Kosongkan untuk tak terbatas">
                        </div>
                        <div class="mb-3">
